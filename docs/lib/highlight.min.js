/*!
 ...
 Languages enabled: Bash, CSS, Diff, Ini, JavaScript, Json, Markdown, PHP, PHP Template, Plain text, Python, Python-Perl, SCSS, Shell, SQL, TypeScript, XML, YAML
 */
...
end:/$/}]}}})();hljs.registerLanguage("diff",e)})();/*! `ini` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `scss` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict"
