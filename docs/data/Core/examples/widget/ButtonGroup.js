targetElement.innerHTML = `<div id="group1" class="centeredColumn" style="display:block;text-align: center"><p>A ButtonGroup containing some buttons</p></div>
<div id="group2" class="centeredColumn" style="display:block;text-align: center"><p>A toggleable ButtonGroup</p></div>`;
