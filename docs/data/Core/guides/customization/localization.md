...
Bryntum Core uses locales for translating texts, date formats and such to different languages. This guide shows you 
how to use the supported locales in Bryntum Core and how to create your own.
...
Bryntum Core ships with the following locales:
...
* `PATH_TO_BUILD` targets the **build** source folder of the distribution zip or the **node_modules/@bryntum/core**
...
```javascript
import { LocaleManager, LocaleHelper } from 'PATH_TO_BUILD/core.module.js';
```
...
```html
<script src="PATH_TO_BUILD/core.umd.js"></script>
```

JavaScript:

```javascript
const { LocaleManager } = window.bryntum.core;
```
...
Bryntum Core ships with two locale management classes [LocaleHelper](#Core/localization/LocaleHelper) and
...
```javascript
import { LocaleHelper } from 'PATH_TO_BUILD/core.module.js';
...
```javascript
import { LocaleManager } from 'PATH_TO_BUILD/core.module.js';
...
```html
<script src="PATH_TO_BUILD/locales/core.locale.SvSE.js"></script>
```
...
The default English (US) locale is part of the Bryntum Core bundle, you don't need to include it separately.
...
```javascript
import 'PATH_TO_BUILD/locales/core.locale.SvSE.js';
```

<div class="note">

The default English locale is part of the Bryntum Core bundle, you don't need to import it separately.
...
import { LocaleManager, LocaleHelper } from 'PATH_TO_BUILD/core.module.js';
// Import default locale SvSE first. This will also publish it
import SvSELocale from 'PATH_TO_BUILD/locales/core.locale.SvSE.js';
...
The code below contains full localization for Bryntum Core which can be used for creating new locales.
