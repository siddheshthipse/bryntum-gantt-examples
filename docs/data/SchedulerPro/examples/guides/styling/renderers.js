const schedulerPro = new SchedulerPro({
    ...
    viewPreset : {
        ...
        headers : [
            {
                unit       : 'week',
                dateFormat : 'ddd DD MMM YYYY' // Mon 01 Jan 2022
            },
            {
                unit     : 'day',
    ...
    events : [
        { resourceId : 1, startDate : '2022-01-01', endDate : '2022-01-10', name : 'Meeting', iconCls : 'fa fa-calendar' },
        { resourceId : 2, startDate : '2022-01-02', endDate : '2022-01-09', name : 'Conference', iconCls : 'fa fa-wine-glass' }
    ],
