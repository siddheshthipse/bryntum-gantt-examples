...
It assumes you have read the [Displaying data](#SchedulerPro/guides/data/displayingdata.md) guide, which has info on how to create a Store, populate it with
...
<a href="#SchedulerPro/guides/data/displayingdata.md#using-inline-data">inline fields</a>
 .
