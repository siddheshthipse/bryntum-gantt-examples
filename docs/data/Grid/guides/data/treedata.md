...
The "[Using a Store](#Grid/guides/data/storebasics.md)" guide describes different ways of retrieving records. Currently only a couple of those are supported
for trees:
...
See the ["Using a store"](#Grid/guides/data/storebasics.md) guide.
