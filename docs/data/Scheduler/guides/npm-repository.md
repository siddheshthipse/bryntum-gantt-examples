...
```shell
npm install @bryntum/scheduler@npm:@bryntum/scheduler-trial@5.6.11
...
```shell
yarn add @bryntum/scheduler@npm:@bryntum/scheduler-trial@5.6.11
yarn add @bryntum/scheduler-angular@5.6.11
```
...
"dependencies": {
  ...
  "@bryntum/scheduler-angular": "5.6.11"
}
```
...
```shell
npm install @bryntum/scheduler@5.6.11
npm install @bryntum/scheduler-angular@5.6.11
```
...
```shell
yarn add @bryntum/scheduler@5.6.11
yarn add @bryntum/scheduler-angular@5.6.11
```
...
```json
"dependencies": {
  "@bryntum/scheduler-lib-trial": "file:./lib/bryntum-scheduler-lib-trial-5.6.11.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-trial-5.6.11.tgz"
}
```
...
```json
"dependencies": {
  "@bryntum/scheduler-lib": "file:./lib/bryntum-scheduler-lib-5.6.11.tgz"  
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-5.6.11.tgz"
}
```
</div>
</div>
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/scheduler@5.6.11’ is not in the npm registry.
```
...
➤ YN0035: │ @bryntum/scheduler@npm:5.6.11: Package not found
