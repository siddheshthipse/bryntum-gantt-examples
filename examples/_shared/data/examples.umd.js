const examples = {
    ...
    Customization : {
        items : [{
            ...
            folder : 'single-assignment',
            title  : 'Customized UI to support single resource assignment',
            since  : '5.5.4'
        }, {
            folder  : 'taskeditor',
    ...
    'React + Vite examples' : {
        ...
        build   : true,
        items   : [{
            folder  : 'frameworks/react-vite/undoredo',
            title   : 'Undo/Redo (React + Vite)',
    ...
    'Vue 3 + Vite examples' : {
        ...
        build   : true,
        items   : [{
            folder  : 'frameworks/vue-3-vite/undoredo',
            title   : 'Undo/Redo',
