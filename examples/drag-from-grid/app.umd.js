...
class Drag extends DragHelper {
  ...
  onDrag({
    ...
    (_context$highlightRow = context.highlightRow) === null || _context$highlightRow === void 0 || _context$highlightRow.removeCls('drag-from-grid-target-task-before');
    if (!context.valid) {
      return;
    }
    if (overRow) {
  ...
  onDrop({
    ...
    highlightRow === null || highlightRow === void 0 || highlightRow.removeCls('drag-from-grid-target-task-before');
