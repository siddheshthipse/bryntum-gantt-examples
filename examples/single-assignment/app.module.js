...
const assignmentPickerConfig = {
    ...
    selectionMode     : {
        multiSelect  : false, // enable single selection in a picker assignmentGrid
        showCheckAll : false
    }
};
...
new Gantt({
                ...
                generalTab   : {
                    items : {
                        ...
                        assignmentField : {
                            ...
                            label  : 'Resource',
                            weight : 350, // put it after effort field
                            flex   : 1,
                            picker : assignmentPickerConfig
                        }
                    }
    ...
    listeners : {
        ...
        beforeTaskSave({ editor, taskRecord }) {
            const
                { assignmentField } = editor.widgetMap,
