...
const gantt = new Gantt({
  ...
  tbar: ['Current timezone:', {
    ...
    // a local system date.
    items: ((_Intl$supportedValues = (_Intl = Intl).supportedValuesOf) === null || _Intl$supportedValues === void 0 ? void 0 : _Intl$supportedValues.call(_Intl, 'timeZone')) || timeZones,
