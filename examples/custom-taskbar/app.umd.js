...
class MyTask extends TaskModel {
  static fields = ['totalHoursWorked', {
    name: 'hoursWorked',
    type: 'array'
  }];
  get workedHoursByDay() {
    ...
    const durationInDays = DateHelper.getDurationInUnit(startDate, endDate, 'd', false),
    ...
    for (let i = 0; i < durationInDays; i++) {
      const intervalStart = DateHelper.add(startDate, i, 'd'),
      ...
      top: {
        renderer({
          ...
          return {
            ...
            children: [taskRecord.name, {
              tag: 'i',
              class: 'b-fa b-fa-clock'
