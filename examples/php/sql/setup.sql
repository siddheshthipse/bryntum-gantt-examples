...
CREATE TABLE IF NOT EXISTS `calendar_intervals` (
  ...
  PRIMARY KEY (`id`),
  INDEX (`calendar`),
  CONSTRAINT `fk_calendar_intervals_calendars` FOREIGN KEY (`calendar`) REFERENCES `calendars`(`id`) ON DELETE CASCADE
) ENGINE=INNODB AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `assignments` (
  ...
  PRIMARY KEY (`id`),
  INDEX (`event`),
  CONSTRAINT `fk_assignments_tasks` FOREIGN KEY (`event`) REFERENCES `tasks`(`id`) ON DELETE CASCADE,
  INDEX (`resource`),
  CONSTRAINT `fk_assignments_resources` FOREIGN KEY (`resource`) REFERENCES `resources`(`id`) ON DELETE CASCADE
) ENGINE=INNODB AUTO_INCREMENT=1;
...
INSERT INTO `calendars` (`id`, `parentId`,`name`) VALUES
(1, null, 'General'),
(2, null, 'Business'),
(3, null, 'Night shift');
