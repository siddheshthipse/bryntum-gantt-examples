            ...
            items : [
                {
                    ...
                    items       : [
                        ...
                        { id : 4, text : 'Time Ranges', selector : '.b-sch-timeranges-canvas' },
                        { id : 5, text : 'Rows', selector : '.b-timeaxissubgrid .b-grid-row' },
                        { id : 6, text : 'Time axis tick lines', selector : '.b-column-lines-canvas' },
                        { id : 7, text : 'Nonworking time', selector : '.b-sch-nonworkingtime-canvas' }
                    ],
