...
const userNames = ['amit', 'dan', 'emilia', 'linda', 'hitomi', 'henrik', 'kate', 'steve'],
    ...
    gantt = new Gantt({
       ...
       */
            taskDrop({
                ...
                this.features.versions.transactionDescription = taskRecords.length === 1 ? `Dragged task ${taskRecords[0].name}` : `Dragged ${taskRecords.length} tasks`;
            },
            taskResizeEnd({
                taskRecord
            }) {
